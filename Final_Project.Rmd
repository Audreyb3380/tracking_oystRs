...
To determine which of these environmental factors influence oyster population values, the most complicated linear model was run through the `dredge()` function to determine the best-fitting nested models within that complex model.
