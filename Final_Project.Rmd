...
To make a prediction about the impact of each environmental factor, the average salinity, pH, water temperature, and divergence in water temperature from the average are plotted individually from 1989 to 2015. This yearly range was selected to align with the years with available oyster data.
